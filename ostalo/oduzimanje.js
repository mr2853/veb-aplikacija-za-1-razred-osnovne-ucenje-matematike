...
document.querySelectorAll("input")[5].value=localStorage.getItem("tacnih_odg_oduzimanje");
...
function proveri(){
    ...
    if(rezultat==rez){
        if(provera2==0){
            ...
            localStorage.setItem("tacnih_odg_oduzimanje",Number(localStorage.getItem("tacnih_odg_oduzimanje"))+1)
            provera2=1;
